...
public class ColorComponent extends CollapsibleContainer
{
    ...
    public ColorComponent(final String title, final String description, final Renderer renderer, final Animation animation, final Renderer componentRenderer, final ColorSetting setting, final boolean alpha, final boolean rainbow, final Toggleable colorModel) {
        super(title, description, renderer, (Toggleable)new SimpleToggleable(false), animation, (Toggleable)null);
        ...
        if (rainbow) {
            this.addComponent((Component)new ColorButton(componentRenderer));
        }
        this.addComponent((Component)new ColorSlider(componentRenderer, 0));
        this.addComponent((Component)new ColorSlider(componentRenderer, 1));
        this.addComponent((Component)new ColorSlider(componentRenderer, 2));
        if (alpha) {
            this.addComponent((Component)new ColorSlider(componentRenderer, 3));
        }
    }
    ...
    protected class ColorButton extends FocusableComponent
    {
        public ColorButton(final Renderer renderer) {
            super("Rainbow", (String)null, renderer);
        }
    ...
    protected class ColorSlider extends Slider
    {
        ...
        protected String getTitle(final int value) {
            switch (value) {
                case 0: {
                    return (ColorComponent.this.colorModel.isOn() ? "Hue:" : "Red:") + " ¡ì7";
                }
                case 1: {
                    return (ColorComponent.this.colorModel.isOn() ? "Saturation:" : "Green:") + " ¡ì7";
                }
                case 2: {
                    return (ColorComponent.this.colorModel.isOn() ? "Brightness:" : "Blue:") + " ¡ì7";
                }
                case 3: {
                    return "Alpha: ¡ì7";
                }

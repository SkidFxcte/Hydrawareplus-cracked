...
public class Frame<V extends Value>
{
    ...
    public void execute(final AbstractInsnNode insn, final Interpreter<V> interpreter) throws AnalyzerException {
        switch (insn.getOpcode()) {
            ...
            case 24:
            case 25: {
                this.push(interpreter.copyOperation(insn, this.getLocal(((VarInsnNode)insn).fd_int_2)));
                break;
            }
            case 46:
            case 47:
            ...
            case 58: {
                ...
                final int var = ((VarInsnNode)insn).fd_int_2;
            ...
            case 132: {
                final int var = ((IincInsnNode)insn).fd_int_1;
            ...
            default: {
                throw new Class18("Illegal opcode " + insn.getOpcode());
            }
        }
    }
